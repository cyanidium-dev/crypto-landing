...
export default function After() {
  return (
    <section
      className="tabxl:flex tabxl:flex-col-reverse container max-w-[1920px] scroll-mt-[82px] tabxl:scroll-mt-[124px] pt-[443px] tabxl:pt-[197px] pb-14 tabxl:pb-[82px]
    ...
    >
      ...
      <div className="tabxl:flex tabxl:justify-between tabxl:items-center tabxl:mb-[60px]">
        <h2 className="tabxl:w-[370px] mb-12 tabxl:mb-0 font-michelin uppercase text-center tabxl:text-left text-24bold tabxl:text-40bold">
