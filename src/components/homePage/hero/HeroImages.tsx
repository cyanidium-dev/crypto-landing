  ...
  return (
    <>
      <motion.div
        ...
        whileInView="visible"
        viewport={{ once: true }}
        variants={fadeInAnimation({ scale: 0.8, delay: 1.6, duration: 1.7 })}
      ...
      <motion.div
        ...
        whileInView="visible"
        viewport={{ once: true }}
        variants={fadeInAnimation({ scale: 0.8, delay: 1.9 })}
      ...
      <div
        ...
        w-[738px] h-[681px] tabxl:w-[1125px] tabxl:h-[1039px] rounded-full bg-black blur-[98px] tabxl:blur-[150px]"
      />
      <div
        className="absolute -z-50 top-[203px] tabxl:top-[-41px] left-[calc(50%-369px+132px)] tabxl:left-[-220px] 
        w-[738px] tabxl:w-[901px] h-[681px] tabxl:h-[677px] tabxl:rotate-[27.22deg] rounded-full bg-black blur-[98px] tabxl:blur-[200px]"
      />
      <div
        className="absolute -z-20 top-[252px] tabxl:top-[451px] left-[calc(50%-320px)] tabxl:left-auto tabxl:right-[-67px] 
        w-[640px] tabxl:w-[865px] h-[350px] tabxl:h-[519px] rounded-full bg-black blur-[89px] tabxl:blur-[132px]"
      />
      <div
        className="hidden tabxl:block absolute -z-20 tabxl:top-[270px] tabxl:right-[-361px] tabxl:w-[1125px] 
        tabxl:h-[1039px] rounded-full bg-black tabxl:blur-[150px]"
      />
      <div
        className="absolute -z-[70] top-[147px] tabxl:top-[184px] left-[calc(50%-213px+77px)] tabxl:left-auto tabxl:right-[-77px] 
        w-[426px] tabxl:w-[649px] h-[490px] tabxl:h-[747px] rounded-full bg-purple blur-[128px] tabxl:blur-[150px]"
      />
      <div
        className="hidden tabxl:block absolute -z-[50] tabxl:top-[-630px] tabxl:left-[-504px] tabxl:w-[785px] 
        tabxl:h-[747px] rounded-full bg-purple tabxl:blur-[150px]"
      />
      <div
        className="absolute -z-[75] top-[-137px] tabxl:top-[-175px] right-[calc(50%-241px-304px)] tabxl:right-[calc(471px)] 
        w-[470px] tabxl:w-[698px] h-[1178px] tabxl:h-[1205px] rounded-full bg-black blur-[68px]"
      />
    </>
  );
}
