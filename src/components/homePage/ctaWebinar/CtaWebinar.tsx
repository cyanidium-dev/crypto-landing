...
export default function CtaWebinar() {
  return (
    <section className="container max-w-[1920px] pt-[42px] tabxl:pt-[96px] pb-[61px] tabxl:pb-[92px] mb-[104px] tabxl:mb-[74px]">
      <h2 className="max-w-[331px] tabxl:max-w-[744px] mb-3 font-michelin uppercase text-24bold tabxl:text-40bold text-transparent bg-clip-text bg-caviarGradient">
